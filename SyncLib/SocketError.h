...
namespace syncit {
   ...
   class SocketError : public FunctionError {
   public:
      SocketError(const string &function);
      SocketError(const string &function, int error) : FunctionError(function), m_error(error) {}
