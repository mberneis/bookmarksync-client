 ...
 */
#ifndef WWWFormDataReader_H
#define WWWFormDataReader_H

#include "SyncLib/Reader.h"

namespace syncit {

   class WWWFormDataReader : public Reader {

   public:
      WWWFormDataReader(Reader *in) {
         m_in = in;
      }
